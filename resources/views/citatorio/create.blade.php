        ...
        <form action="{{route('citatorio.store')}}" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input placeholder="Nombre del Padre" type="text" name="nombre_padre" id="nombre_padre" class="form-control" value="{{ old('nombre_padre') }}">
                    @error('nombre_padre')
                ...
                <div class="col-md-6">
                    ...
                    <select title="Seleccione una hora..." name="hora_cita" id="hora_cita" class="form-control selectpicker show-tick">
                        @foreach([8, 9, 10, 11, 12, 13, 14, 15, 16] as $hora_cita)
                            @php
                                // Formatear la hora en formato HH:MM:SS
                                $hora_formateada = sprintf("%02d:00:00", $hora_cita);
                            @endphp
                            <option value="{{ $hora_formateada }}" {{ old('hora_cita') == $hora_formateada ? 'selected' : '' }}>
                                {{ $hora_cita }}:00
                            </option>
                        @endforeach
                    </select>

                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <input type="date" name="fecha_reporte" id="fecha_reporte" class="form-control" value="{{ old('fecha_reporte') }}">
                            </div>
                            <div class="col-auto">
                                @error('fecha_reporte')
                    ...
                    <div class="form-group">
                        ...
                        <select title="Seleccione la(s) falta(s)..." name="motivo[]" id="motivo" class="form-control selectpicker" multiple>
                            ...
                            <option value="No portar adecuadamente el uniforme">No portar adecuadamente el uniforme</option>
                            <option value="Agredir verbalmente a sus compañeros">Agredir verbalmente a sus compañeros</option>
                            <option value="Destruir el material de sus compañeros">Destruir el material de sus compañeros</option>
                            <option value="Presentar trabajos de mala calidad">Presentar trabajos de mala calidad</option>
                    ...
                    <div class="form-group" id="otro-motivo" style="display: none;">
                        ...
                        <input type="text" name="motivo_otro" id="motivo_otro" class="form-control" style="width: 300px;">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" name="hora_clase" id="hora_clase" class="form-control" value="{{ old('hora_clase') }}" required>
                        @error('hora_clase')
                        <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="observaciones" id="observaciones" class="form-control" value=value="{{ old('nombre_profesor') }}"></textarea>
                        @error('observaciones')
                        <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>

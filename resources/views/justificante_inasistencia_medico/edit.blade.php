        ...
        <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
            <form action="{{ route('justificante_inasistencia_medico.update', $justificante) }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <input type="hidden" name="expediente_medico_id" id="expediente_medico_id"
                        value="{{ old('expediente_medico_id', $justificante->expediente_medico_id) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="grado" id="grado" class="form-control">
                            ...
                            @foreach(['1', '2', '3', '4', '5', '6'] as $grado)
                                <option value="{{ $grado }}" {{ old('grado', $justificante->grado) == $grado ? 'selected' : '' }}>
                                    {{ $grado }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="grupo" id="grupo" class="form-control">
                            ...
                            @foreach(['A', 'B', 'C', 'D'] as $grupo)
                                <option value="{{ $grupo }}" {{ old('grupo', $justificante->grupo) == $grupo ? 'selected' : '' }}>
                                    {{ $grupo }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="fecha" id="fecha" class="form-control"
                            value="{{ old('fecha', $justificante->fecha) }}">
                        @error('fecha')
                            <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="modulos" id="modulos" class="form-control"
                            value="{{ old('modulos', $justificante->modulos) }}">
                        @error('modulos')
                            <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 text-center">
                        ...
                        <a href="{{ route('justificante_inasistencia_medico.index') }}"

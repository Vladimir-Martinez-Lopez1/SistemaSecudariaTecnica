...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <h1 class="mt-4">Pase de salida General</h1>
        ...
        <div class="mb-4">
            <a href="{{route('pase_salida.create')}}">
                    ...
                    <tbody>
                        @foreach ($pases as $pase)
                            <tr>
                                ...
                                <td>{{$pase->expedienteDisciplinario->alumno->nombre }} {{ $pase->expedienteDisciplinario->alumno->apellido }}</td>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <a href="{{ route('pase_salida.show', ['pase_salida' => $pase->id, 'from_pase_salida' => false]) }}">

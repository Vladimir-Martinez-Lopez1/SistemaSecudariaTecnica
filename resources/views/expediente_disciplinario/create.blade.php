...
@section('title', 'Crear expediente disciplinario')
...
@section('content')
        <div class="container-fluid px-4">
            <h1 class="mt-4">Crear Expedientes Disciplinarios</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{route('panel')}}">Inicio</a></li>
                <li class="breadcrumb-item"><a href="{{route('expediente_disciplinario.index')}}">Expedientes Disciplinarios</a></li>
                <li class="breadcrumb-item active">Crear Expediente Disciplinario</li>
            </ol>

            <!-- Formulario-->
            <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
                <form action="{{route('expediente_disciplinario.store')}}" method="post">
                    @csrf
                    <div class="row g-3">

...
@section('title','Editar Informacion de Expediente Disciplinario')
...
<div class="container-fluid px-4">
    <h1 class="mt-4">Editar Información Expediente Disciplinario</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{route('panel')}}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="{{route('expedientes_medicos.index')}}">Expedientes Disciplinarios</a></li>
        <li class="breadcrumb-item active">Editar Expedientes Disciplinarios</li>
    </ol>

    <!-- Formulario-->
    <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
        <form action="{{ route('expediente_disciplinario.update', $expediente) }}" method="post">
            @method('PATCH')
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
